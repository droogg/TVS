...
def performDetect(imagePath="/home/vic/PycharmProjects/DS_neuro/Task/detection/MY/exp_del/cr/1/top_potsdam_2_10_RGB_CROP_1.png", thresh= 0.25, configPath = "./cfg/yolov4-cowc_carpk.cfg", weightPath = "yolov4-cowc_carpk_best.weights", metaPath= "./cfg/cowc_carpk.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
    ...
    return detections
#thresh= 0.25, configPath = "./cfg/yolov4-cowc_carpk.cfg", weightPath = "yolov4-cowc_carpk_best.weights", metaPath= "./cfg/cowc_carpk.data", showImage= True, makeImageOnly = False, initOnly= False):

def performBatchDetect(sample, thresh= 0.25, configPath = "./cfg/yolov4-cowc_carpk.cfg", weightPath = "yolov4-cowc_carpk_best.weights", metaPath= "./cfg/cowc_carpk.data", hier_thresh=.5, nms=.45, batch_size=8):
    import cv2
    import numpy as np
